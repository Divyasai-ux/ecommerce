...
<div class="main-content-container container-fluid px-4">
                  ...
                  <div class="card-body p-0 d-flex">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        ...
                        <h6 class="stats-small__value count my-3">{{$subscount}}</h6>
                      </div>
                      <div class="stats-small__data">
            ...
            <div class="row">
              ...
              <!-- New Draft Component -->
              <div class="col-lg-4 col-md-6 col-sm-12 mb-4" hidden="">
                <!-- Quick Post -->
                <div class="card card-small h-100">
                  <div class="card-header border-bottom">
                  ...
                  <div class="card-body p-0">
                    @foreach($faqs as $faq)
                      ...
                      <div class="blog-comments__content">
                        ...
                        <p class="m-0 my-1 mb-2 text-muted">{{$faq->answer}}</p>
                      </div>
                    </div>   
                  </div>
                  <!-- <hr> -->
                  ...
                  <div class="card-footer border-top">
                    <div class="row">
                      <div class="col text-center view-report">
                        <button type="submit" class="btn btn-white">View All Faqs</button>
                      </div>
                    </div>
                  </div>
                </div>
